...
<head>
    ...
    <style>
        body {
            ...
            color: #000000ff; /* Sophisticated dark gray */
            display: flex;
        ...
        .chat-bubble strong {
            font-weight: 600;
            color: #d58524ff; /* Darker gray for emphasis */
        }
        ...
        input[type="submit"] {
            background-color: #d7a447ff; /* Professional blue */
            color: white;
            padding: 15px 25px;
            border: none;
            border-radius: 10px;
        ...
        input[type="submit"]:hover {
            background-color: #ed9b18ff; /* Darker blue on hover */
...
<body>
    ...
    <form method="post" action="/ai2" id="chatForm">
        @csrf
        <label for="prompt">क्या परेशानि हैं वत्स / what's worrying you dear - </label><br>
